	...
	private void foodWindow(Food food){
		...
		saveAndClose.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent evt){
				...
				if(isNew){
					try {
						String stringToCheck = quantity.getText();
						for (int i = 0; i < stringToCheck.length(); i++) {
							int ascii = (int) stringToCheck.charAt(i);	// get the current character ascii value
							
							// check if the characters are valid by ascii values (space, &, a-z, A-Z)
							if ((ascii < 48)||(ascii > 57)) {
								throw new InvalidInputException ("Popularity must be a number! ");
							}
						}
						stringToCheck = price.getText();
						for (int i = 0; i < stringToCheck.length(); i++) {
							int ascii = (int) stringToCheck.charAt(i);	// get the current character ascii value
							
							// check if the characters are valid by ascii values (space, &, a-z, A-Z)
							if ((ascii < 44) || (ascii > 57)) {
					...
					try {
						...
						for (int i = 0; i < stringToCheck.length(); i++) {
							...
							// check if the characters are valid by ascii values (space, &, a-z, A-Z)
							if ((ascii < 44) || (ascii > 57)) {
								throw new InvalidInputException ("New popularity must be a number! ");
							}
						}
						stringToCheck = price.getText();
						for (int i = 0; i < stringToCheck.length(); i++) {
							...
							// check if the characters are valid by ascii values (space, &, a-z, A-Z)
							if ((ascii < 44) || (ascii > 57)) {
								throw new InvalidInputException ("New price must be a number! ");
							}
						}
				...
				if(isNew){
					try {
						...
						for (int i = 0; i < stringToCheck.length(); i++) {
							...
							// check if the characters are valid by ascii values (space, &, a-z, A-Z)
							if ((ascii < 48)||(ascii > 57)) {
								throw new InvalidInputException ("Quantity must be a number! ");
							}
						}
					...
					try {
						...
						for (int i = 0; i < stringToCheck.length(); i++) {
							...
							// check if the characters are valid by ascii values (space, &, a-z, A-Z)
							if ((ascii < 48)||(ascii > 57)) {
								throw new InvalidInputException ("New quantity must be a number! ");
							}
						}
